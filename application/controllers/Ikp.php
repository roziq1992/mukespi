...
class Ikp extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'index.php/ikp?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'index.php/ikp?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'index.php/ikp';
            $config['first_url'] = base_url() . 'index.php/ikp';
        }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Save',
            'action' => site_url('ikp/create_action'),
    ...
    public function create_action() 
    {
		...
		'jam_lapor' => $this->input->post('jam_lapor',TRUE),
    ...
    public function update($id) 
    {
		...
		'jam_lapor' => set_value('jam_lapor', $row->jam_lapor),
	...
	$this->form_validation->set_rules('jam_lapor', 'jam lapor', 'trim|required');
	...
	xlsWriteLabel($tablehead, $kolomhead++, "Jam Lapor");
	...
	foreach ($this->Ikp_model->get_all() as $data) {
	    ...
	    xlsWriteLabel($tablebody, $kolombody++, $data->jam_lapor);
