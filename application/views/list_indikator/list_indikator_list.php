...
<style>
	/* Fix utama: Memaksa Modal & Backdrop Bootstrap berada di paling atas */
	.modal-backdrop {
	...
	.mutu-wrapper {
		...
		position: relative;
		z-index: auto; /* Mencegah terciptanya stacking context jebakan */
	}
	...
	.mutu-table tbody tr:last-child td {
		border-bottom: none;
	}
	...
	.btn-act-edit {
		background: #ffffff;
		border-color: var(--mutu-border);
		color: var(--mutu-slate);
	}

	.btn-act-edit:hover {
		background: var(--mutu-bg);
		border-color: #cbd5e1;
		color: var(--mutu-dark);
	}

	.btn-act-data {
		background: var(--mutu-dark);
	...
	.mutu-pagination-container a {
		background: #ffffff;
		border: 1px solid var(--mutu-border);
		color: var(--mutu-slate);
	}

	.mutu-pagination-container a:hover {
		background: var(--mutu-primary-light);
		border-color: var(--mutu-primary);
		color: var(--mutu-primary);
	}

	.mutu-pagination-container span {
		background: var(--mutu-primary);
		color: #ffffff;
		border: 1px solid var(--mutu-primary);
	}

	.mutu-pagination-container ul {
		list-style: none;
		display: flex;
		margin: 0;
		padding: 0;
	...
	@media (max-width: 768px) {
		...
		.mutu-table, .mutu-table tbody, .mutu-table tr, .mutu-table td {
			display: block;
			width: 100%;
		}
	...
	<div class="mutu-wrapper">
			...
			<div class="mutu-header-content">
				<div class="mutu-header-title">
					<div class="mutu-header-icon">
						<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 19V5a1 1 0 0 1 1-1h9l6 6v9a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1z"/><path d="M14 4v6h6"/><path d="M8 13h8M8 17h5"/></svg>
					</div>
					<div>
		...
		<div class="mutu-toolbar">
			...
			<form action="<?php echo site_url('List_indikator/index'); ?>" class="mutu-search" method="get">
				<div class="mutu-search-box">
					...
					<?php if ($q <> '') { ?>
						<a href="<?php echo site_url('List_indikator'); ?>" class="btn-reset-search">Reset</a>
					<?php } ?>
		...
		<div class="mutu-table-wrap">
				...
				foreach ($list_indikator_data as $list_indikator)
				{
					...
					<tr>
						...
						<td data-label="Target">
							<div class="gauge-ring" style="--pct: <?php echo (int) $list_indikator->target ?>;">
			...
			<div class="mutu-empty-state">
				...
				<p>Belum ada data indikator yang ditemukan.</p>
			</div>
			<?php } ?>
		</div>
