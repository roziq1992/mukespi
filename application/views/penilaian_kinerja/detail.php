        ...
        <div class="card shadow mb-3">
            <div class="card-body pk-result">
                <div class="text-center mb-3">
                    <div class="font-weight-bold" style="font-size:1.1rem;">FORMULIR PENILAIAN KINERJA PEGAWAI</div>
                    <div class="text-muted">RS AIRLANGGA &mdash; <?php echo html_escape($penilaian->nama_periode); ?></div>
                </div>
                <div class="row mb-3">
                    <div class="col-md">
                        <div class="small text-muted"><?php echo !empty($penilaian->is_kepala_dinilai) ? 'KEPALA UNIT YANG DINILAI' : 'PEGAWAI YANG DINILAI'; ?></div>
                        <div class="font-weight-bold"><?php echo html_escape($penilaian->nama_dinilai); ?></div>
                        <small class="text-muted"><?php echo html_escape($penilaian->email_dinilai); ?></small>
                    </div>
                    <div class="col-md">
                    ...
                    <div class="col-md">
                        <div class="small text-muted">PEJABAT PENILAI</div>
                        <div class="font-weight-bold"><?php echo html_escape($penilaian->nama_penilai); ?></div>
                        <small class="text-muted"><?php echo html_escape($penilaian->email_penilai); ?></small>
                    </div>
                    <div class="col-md">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-4 text-center">
                        <div><?php echo html_escape(isset($penilai_label) ? $penilai_label : 'Penilai (Kepala Unit)'); ?>,</div>
                        <div style="height:60px;"></div>
                        <div class="font-weight-bold">( <?php echo html_escape($penilaian->nama_penilai); ?> )</div>
                    </div>
                    <div class="col-4 text-center">
