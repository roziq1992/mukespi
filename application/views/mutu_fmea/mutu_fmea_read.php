...
?>
 ...
 <div class="card shadow mb-4">
    ...
    <body>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('mutu_fmea?id='.$id_indikator.'&judul='.$judul) ?>" class="btn btn-default">Kembali</a>
	    <a href="<?php echo site_url('mutu_fmea/cetak/'.$id_fmea) ?>" class="btn btn-default" target="_blank">Cetak</a>
	    </td></tr>
	</table>
