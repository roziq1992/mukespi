<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Laporan Cuci Tangan Per profesi - per Kesempatan</h6>
        </div>
        <div class="card-body">
                        ...
                        <div class="col-sm-12">
                            <div class="row" style="margin-bottom: 10px">
                                ...
                                <div class="col-md-6 text-right">
                                    <form action="<?php echo site_url('cuci_tangan/lprtunit'); ?>" class="form-inline" method="get">
...
<?php
                                    ...
                                    GROUP BY cuci_tangan.profesi,cuci_tangan.kesempatan,cuci_tangan.tanggal	
                                    order BY cuci_tangan.profesi,cuci_tangan.kesempatan, cuci_tangan.tanggal asc
                                    ')->result();
